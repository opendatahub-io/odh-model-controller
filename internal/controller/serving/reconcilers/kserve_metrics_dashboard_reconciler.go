...
//   - KServeRuntimeAnnotation with TgisRuntimeName: Returns CaikitMetricsData
//
// Parameters:
...
func getMetricsData(runtime *kservev1alpha1.ServingRuntime) (string, bool) {
	...
	case runtime.Spec.Annotations[constants.KServeRuntimeAnnotation] == constants.CaikitRuntimeName:
		return constants.CaikitMetricsData, true
	default:
		return "", false
	}
}
