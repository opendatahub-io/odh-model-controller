...
const (
	...
	InferenceService2               = "./testdata/deploy/openvino-inference-service-timeout.yaml"
	...
	KserveInferenceServicePath2     = "./testdata/deploy/kserve-openvino-inference-service-timeout.yaml"
