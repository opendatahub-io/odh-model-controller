...
const (
	...
	InferenceService2               = "./testdata/deploy/openvino-inference-service-custom-timeout.yaml"
	InferenceService3               = "./testdata/deploy/openvino-inference-service-default-timeout.yaml"
