...
func (r *GatewayReconciler) getEffectiveGatewayRefs(ctx context.Context, llmSvc *kservev1alpha1.LLMInferenceService) []kservev1alpha1.UntypedObjectReference {
	logger := log.FromContext(ctx)

	var refs []kservev1alpha1.UntypedObjectReference
...
func (r *GatewayReconciler) fetchLLMISvcConfig(ctx context.Context, name, namespace string) (*kservev1alpha1.LLMInferenceServiceConfig, error) {
...
func (r *GatewayReconciler) enqueueGatewaysFromLLMInferenceService() handler.EventHandler {
	return handler.EnqueueRequestsFromMapFunc(func(ctx context.Context, object client.Object) []reconcile.Request {
		llmSvc, ok := object.(*kservev1alpha1.LLMInferenceService)
		if !ok {
			return nil
		}
...
func getGatewayRefs(llmSvc *kservev1alpha1.LLMInferenceService) []kservev1alpha1.UntypedObjectReference {
