...
// Pin to v0.3.0 to match ODH kserve fork (which imports api/v1alpha2, removed in v1.0+)
...
// Pin k8s.io packages and transitive deps to v0.33.1 to match kserve ODH stable-2.x fork
replace (
