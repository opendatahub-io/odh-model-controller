...
// Pin gateway-api-inference-extension to v0.3.0 (kserve fork imports api/v1alpha2, removed in v1.0+)
replace sigs.k8s.io/gateway-api-inference-extension => sigs.k8s.io/gateway-api-inference-extension v0.3.0

// Pin gateway-api to v1.2.1 (BackendLBPolicy graduated from v1alpha2 in v1.4+, breaks policy-machinery v0.6.4)
replace sigs.k8s.io/gateway-api => sigs.k8s.io/gateway-api v1.2.1

// Pin k8s.io and transitive deps to v0.33.1 to match kserve ODH stable-2.x fork.
// kubeflow/hub v0.3.9 pulls k8s v0.34+, but the kserve fork requires v0.33.1.
replace (
